	...
	<table class="table table-bordered table-striped">
		...
		<?php $no=1; foreach ($input_absensi as $a) :?>
			<tr>
				...
				<input type="hidden" name="jenis_kelamin[]" value="<?php echo $a->jenis_kelamin ?>" class="form-control">				<input type="hidden" name="nama_jabatan[]" value="<?php echo $a->nama_jabatan ?>" class="form-control">
				<td><?php echo $no++ ?></td>
